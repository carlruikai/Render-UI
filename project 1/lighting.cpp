...
glm::vec3 lightPos(1.2f, 1.0f, 2.0f); //world position
...
int main()
{
    ...
    Shader lightingShader = Shader("lightingvertex.txt", "lightingfragment.txt");
    ...
    int width, height;
    //unsigned char* image = stbi_load("container2.png", &width, &height, &nrChannels, 3);
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        GLint lightDirLoc = glGetUniformLocation(lightingShader.ID, "light.direction");
        ...
        glUniform3f(glGetUniformLocation(lightingShader.ID, "pointLights[0].ambient"), 0.05f, 0.05f, 0.05f);
        glUniform3f(glGetUniformLocation(lightingShader.ID, "pointLights[0].diffuse"), 0.8f, 0.8f, 0.8f);
        glUniform3f(glGetUniformLocation(lightingShader.ID, "pointLights[0].specular"), 1.0f, 1.0f, 1.0f);
        ...
        glUniform3f(glGetUniformLocation(lightingShader.ID, "pointLights[1].ambient"), 0.05f, 0.05f, 0.05f);
        glUniform3f(glGetUniformLocation(lightingShader.ID, "pointLights[1].diffuse"), 0.8f, 0.8f, 0.8f);
        glUniform3f(glGetUniformLocation(lightingShader.ID, "pointLights[1].specular"), 1.0f, 1.0f, 1.0f);
        ...
        glUniform3f(glGetUniformLocation(lightingShader.ID, "pointLights[2].ambient"), 0.05f, 0.05f, 0.05f);
        glUniform3f(glGetUniformLocation(lightingShader.ID, "pointLights[2].diffuse"), 0.8f, 0.8f, 0.8f);
        glUniform3f(glGetUniformLocation(lightingShader.ID, "pointLights[2].specular"), 1.0f, 1.0f, 1.0f);
        ...
        glUniform3f(glGetUniformLocation(lightingShader.ID, "pointLights[3].ambient"), 0.05f, 0.05f, 0.05f);
        glUniform3f(glGetUniformLocation(lightingShader.ID, "pointLights[3].diffuse"), 0.8f, 0.8f, 0.8f);
        glUniform3f(glGetUniformLocation(lightingShader.ID, "pointLights[3].specular"), 1.0f, 1.0f, 1.0f);
